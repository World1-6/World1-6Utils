package com.andrew121410.mc.world16utils.legacy;
...
@Deprecated
public class LegacyBukkitSerialization {
    ...
    public static String[] turnInventoryIntoBase64s(Player player) {
        ...
        String inventoryBase64 = LegacyBukkitSerialization.itemStackArrayToBase64(inventoryContents.toArray(new ItemStack[0]));
        String armorBase64 = LegacyBukkitSerialization.itemStackArrayToBase64(armorContents.toArray(new ItemStack[0]));
    ...
    public static void giveFromBase64s(Player player, String[] base64s) {
        ...
        try {
            inventoryItemStacks = LegacyBukkitSerialization.base64ToItemStackArray(base64s[0]);
            armorItemStacks = LegacyBukkitSerialization.base64ToItemStackArray(base64s[1]); // Not in use yet.
        } catch (IOException e) {
